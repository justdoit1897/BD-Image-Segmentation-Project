...
Un itemset (un insieme di elementi) è detto di cardinalità $k$ se contiene esattamente $k$ item all'interno della transazione. 

È possibile che uno stesso itemset si rilevi in più transazioni, per cui è opportuno definire il concetto di supporto.
